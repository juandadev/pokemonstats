...
import { INSPIRATIONS, TOOLS } from '@/common/constants';
import { useTranslation } from '@/i18n';

export default function ThanksPage() {
  const { t, locale } = useTranslation();
  const inspirations = INSPIRATIONS[locale];
      ...
      <div className="relative z-10 container mx-auto max-w-6xl">
        <div className="mb-8">
          ...
          >
            ...
            <span className="text-sm font-medium">
              {t('pages.thanks.backButton', 'Back to Pokemon Stats')}
            </span>
          </Link>
        </div>
        <div className="text-center mb-12">
          <div className="inline-flex items-center gap-2 bg-pink-100 text-pink-800 px-4 py-2 rounded-full text-sm font-medium mb-6">
            ...
            {t('pages.thanks.badge', 'Special Thanks')}
          </div>
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
            {t('pages.thanks.title', 'Thank You!')}
          </h1>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            {t(
              'pages.thanks.description',
              "Pokemon Stats wouldn't be possible without the amazing community, contributors, and the incredible tools and resources that inspire us every day."
            )}
          </p>
        </div>
        {/*<CoffeeSupporters />*/}
        ...
        <Card className="mb-12 shadow-xl border-0 bg-white/90 backdrop-blur-sm">
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
              ...
              {t(
                'pages.thanks.inspirations.title',
                'Inspirations & References'
              )}
            </CardTitle>
            <p className="text-gray-600">
              {t(
                'pages.thanks.inspirations.description',
                'Incredible projects and resources that inspired Pokemon Stats and helped shape our vision.'
              )}
            </p>
          </CardHeader>
          <CardContent>
        ...
        <Card className="mb-12 shadow-xl border-0 bg-white/90 backdrop-blur-sm">
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
              ...
              {t('pages.thanks.tools.title', 'Tools & Technologies')}
            </CardTitle>
            <p className="text-gray-600">
              {t(
                'pages.thanks.tools.description',
                'Amazing tools and technologies that make Pokemon Stats possible. Thank you to all the open-source maintainers!'
              )}
            </p>
          </CardHeader>
          <CardContent>
          ...
          <CardContent className="p-8">
            <div className="text-center">
              ...
              <h2 className="text-2xl font-bold text-gray-900 mb-4">
                {t('pages.thanks.cta.title', 'Want to Be Featured Here?')}
              </h2>
              <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
                {t(
                  'pages.thanks.cta.description',
                  'There are many ways to support Pokemon Stats and join our amazing community of contributors and supporters.'
                )}
              </p>
              <div className="grid md:grid-cols-3 gap-4 mb-6 max-w-3xl mx-auto">
                <div className="bg-white/80 backdrop-blur-sm rounded-lg p-4 border border-pink-200">
                  ...
                  <div className="text-sm font-semibold text-gray-900">
                    {t('pages.thanks.cta.cards.code.title', 'Contribute Code')}
                  </div>
                  <div className="text-xs text-gray-600">
                    {t(
                      'pages.thanks.cta.cards.code.description',
                ...
                <div className="bg-white/80 backdrop-blur-sm rounded-lg p-4 border border-purple-200">
                  ...
                  <div className="text-sm font-semibold text-gray-900">
                    {t(
                      'pages.thanks.cta.cards.coffee.title',
                      'Buy Me a Coffee'
                    )}
                  </div>
                  <div className="text-xs text-gray-600">
                    {t(
                      'pages.thanks.cta.cards.coffee.description',
                      'Support development'
                    )}
                  </div>
                </div>
                <div className="bg-white/80 backdrop-blur-sm rounded-lg p-4 border border-blue-200">
                  <div className="text-2xl mb-2">⭐</div>
                  <div className="text-sm font-semibold text-gray-900">
                    {t('pages.thanks.cta.cards.star.title', 'Star on GitHub')}
                  </div>
                  <div className="text-xs text-gray-600">
                    {t(
                      'pages.thanks.cta.cards.star.description',
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                >
                  ...
                  >
                    ...
                    {t(
                      'pages.thanks.cta.buttons.github',
                ...
                >
                  ...
                  >
                    ...
                    {t('pages.thanks.cta.buttons.coffee', 'Buy Me a Coffee')}
                  </a>
                </Button>
              </div>
            </div>
        ...
        <div className="mt-12 flex flex-col sm:flex-row gap-4 justify-center">
          ...
          >
            <Link href="/">
              {t('pages.thanks.footer.backButton', 'Back to Pokemon Stats')}
            </Link>
          </Button>
          <Button
          ...
          >
            <Link href="/roadmap">
              {t('pages.thanks.footer.roadmapButton', 'View Project Roadmap')}
            </Link>
          </Button>
        </div>
      </div>
