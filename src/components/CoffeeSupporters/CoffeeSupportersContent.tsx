...
export default function CoffeeSupportersContent({
  supporters,
}: CoffeeSupportersContentProps) {
    ...
    <Card className="mb-12 shadow-xl border-0 bg-white/90 backdrop-blur-sm">
      <CardHeader>
        <CardTitle className="flex items-center gap-2">
          ...
          {t('components.coffeeSupporters.title', 'Recent Supporters')}
          <Badge className="bg-yellow-100 text-yellow-800 ml-2">
            ${totalAmount} {t('components.coffeeSupporters.raised', 'raised')}
          </Badge>
        </CardTitle>
        <p className="text-gray-600">
          {t(
            'components.coffeeSupporters.description',
            'Thank you to everyone who has supported the project! Your contributions help keep Pokemon Stats free and ad-free.'
          )}
        </p>
      </CardHeader>
      <CardContent>
            ...
            >
              ...
              <div className="text-right">
                ...
                <div className="text-xs text-gray-500">
                  {t('components.coffeeSupporters.donation', 'donation')}
                </div>
              </div>
            </div>
          ))}
          ...
          <div className="text-center pt-4">
            ...
            >
              ...
              >
                ...
                {t(
                  'components.coffeeSupporters.supportButton',
                  'Support the Project'
                )}
              </a>
            </Button>
