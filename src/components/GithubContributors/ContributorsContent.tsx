    ...
    <Card className="mb-12 shadow-xl border-0 bg-white/90 backdrop-blur-sm">
      <CardHeader>
        <CardTitle className="flex items-center gap-2">
          ...
          {t('components.contributors.title', 'Contributors')}
          <Badge className="bg-blue-100 text-blue-800 ml-2">
            {contributors.length}{' '}
            {t('components.contributors.count', 'contributors')}
          </Badge>
        </CardTitle>
        <p className="text-gray-600">
          {t(
            'components.contributors.description',
            'Amazing developers, artists and designers who have contributed code, design, documentation, and improvements to Pokémon Stats.'
          )}
        </p>
      </CardHeader>
      <CardContent>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {contributors.length === 0 && (
            <p className="text-sm opacity-70">
              {t(
                'components.contributors.noContributors',
                  ...
                  <div className="flex items-center gap-1 mt-1">
                    ...
                    <span className="text-xs text-gray-500">
                      {contributor.custom_contribution ??
                        `${contributor.contributions} ${t(
                          'components.contributors.commits',
                          'commits'
                        )}`}
                    </span>
                  </div>
        ...
        <div className="text-center pt-6">
          ...
          >
            ...
            >
              ...
              {t(
                'components.contributors.viewAllButton',
